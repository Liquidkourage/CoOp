  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto', padding: '20px' }}>
      ...
      <div style={{ marginBottom: '30px' }}>
        <Link href={`/sets/${params.id}`} style={{ color: '#0066cc', textDecoration: 'none' }}>
          ← Back to Set
        </Link>
      </div>

      <h1 style={{ marginBottom: '30px' }}>Edit Set</h1>
      ...
      <form onSubmit={handleSubmit} style={{
        ...
        <div style={{ marginBottom: '20px' }}>
          <label style={{ display: 'block', marginBottom: '5px', fontWeight: '600' }}>
            Set Name <span style={{ color: 'red' }}>*</span>
          </label>
          <input
            type="text"
            value={formData.name}
